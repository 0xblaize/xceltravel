          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {isLoadingUsers ? (
              ...
              <div className="col-span-full py-20 flex flex-col items-center justify-center border-2 border-dashed border-slate-200 dark:border-white/5 rounded-3xl">
                ...
                <p className="text-slate-500 font-bold text-sm text-center px-10">
                  No users found in your area yet. Be the first to invite
                  friends!
                </p>
              </div>
            ) : (
                ...
                {pendingRequests.map((req) => (
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      <button className="h-8 w-8 rounded-full border border-green-200 text-green-500 flex items-center justify-center hover:bg-green-50">
                        <Check size={14} />
                      </button>
                      <button className="h-8 w-8 rounded-full border border-red-200 text-red-500 flex items-center justify-center hover:bg-red-50">
                        <X size={14} />
                      </button>
                    </div>
                  </div>
